...
if __name__ == '__main__':
    ...
    save_acc_matrix(acc_matrix, method_name="Vanilla", n_tasks=args.n_tasks, seed=args.seed)
    plot_acc_lines(acc_matrix, method_name="Vanilla", n_tasks=args.n_tasks)
    tracker.print_summary()
    tracker.save_report(f"reports/cost_Vanilla_{args.n_tasks}tasks_seed{args.seed}.csv")
