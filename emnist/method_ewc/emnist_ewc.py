...
if __name__ == '__main__':
    ...
    save_acc_matrix(acc_matrix, method_name="EMNIST_EWC", n_tasks=args.n_tasks, seed=args.seed)
    plot_acc_lines(acc_matrix, method_name="EMNIST_EWC", n_tasks=args.n_tasks)
    tracker.print_summary()
    tracker.save_report(f"emnist/reports/cost_EWC_{args.n_tasks}tasks_seed{args.seed}.csv")
